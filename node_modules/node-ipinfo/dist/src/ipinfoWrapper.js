...
var IPinfoWrapper = (function () {
    function IPinfoWrapper(token, cache, timeout, i18nData) {
        this.mapLimitErrorMessage = "You have exceeded maximum IP upload limit per request.";
        this.token = token;
        this.countries = (i18nData === null || i18nData === void 0 ? void 0 : i18nData.countries) ? i18nData.countries : utils_1.defaultCountries;
        this.countriesFlags = (i18nData === null || i18nData === void 0 ? void 0 : i18nData.countriesFlags) ? i18nData.countriesFlags : utils_1.defaultCountriesFlags;
        this.countriesCurrencies = (i18nData === null || i18nData === void 0 ? void 0 : i18nData.countriesCurrencies) ? i18nData.countriesCurrencies : utils_1.defaultCountriesCurrencies;
        this.continents = (i18nData === null || i18nData === void 0 ? void 0 : i18nData.continents) ? i18nData.continents : utils_1.defaultContinents;
        this.euCountries =
            (i18nData === null || i18nData === void 0 ? void 0 : i18nData.euCountries) && (i18nData === null || i18nData === void 0 ? void 0 : i18nData.euCountries.length) !== 0
                ? i18nData.euCountries : utils_1.defaultEuCountries;
                                        ...
                                        if (!_this.is4xxOr5xx(res.statusCode)) {
                                            res.on("close", function () {
                                                ...
                                                if (ipinfo.country) {
                                                    ...
                                                    ipinfo.continent =
                                                        _this.continents[ipinfo.countryCode];
